...
const CreateTimeline = () => {
  ...
  const joyrideSteps = [
    ...
    },
    {
      ...
      content:
        "This process usually takes around ten minutes. If you need to take a break, feel free to click this button to generate an edit link to your timeline. Your work will be saved!",
    },
    {
      placement: "center",
      target: "body",
